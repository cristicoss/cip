  ...
  _getJobs() {
    ...
    request.onload = async function () {
      ...
      if (!jobID) {
        ...
        const displayJobs = function (jobs) {
          if (jobs.length > 0) {
            jobs.forEach((job) => {
              const html = `
            <a href="https://cip-new.webflow.io/projectmanagers?jobid=${job.id}" class="job_title-wrapper w-inline-block">
      ...
      backBtn.addEventListener("click", function () {
        window.location.href = `https://cip-new.webflow.io/projectmanagers`;
      });

      btnSpontan.addEventListener("click", function () {
        window.location.href = `https://cip-new.webflow.io/projectmanagers/?jobid=109507`;
      });
    };
